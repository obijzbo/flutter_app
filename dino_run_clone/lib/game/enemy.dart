...
enum EnemyType { AngryPig, Bat, BlueBird, Bunny, Chameleon, Rino }
...
class Enemy extends AnimationComponent {
  ...
  static Map<EnemyType, EnemyData> _enemyDetails = {
    EnemyType.AngryPig: EnemyData(
      imageName: 'Enemy/AngryPig/Walk (36x30).png',
      nColumns: 16,
      nRows: 1,
      textureHeight: 30,
      textureWidth: 36,
    ...
    EnemyType.Bat: EnemyData(
      imageName: 'Enemy/Bat/Flying (46x30).png',
      nColumns: 7,
      nRows: 1,
      textureHeight: 30,
      textureWidth: 46,
    ...
    EnemyType.BlueBird: EnemyData(
      imageName: 'Enemy/BlueBird/Flying (32x32).png',
      nColumns: 9,
      nRows: 1,
      textureHeight: 32,
      textureWidth: 32,
    ...
    EnemyType.Bunny: EnemyData(
      imageName: 'Enemy/Bunny/Run (34x44).png',
      nColumns: 12,
      nRows: 1,
      textureHeight: 44,
      textureWidth: 34,
    ...
    EnemyType.Chameleon: EnemyData(
      imageName: 'Enemy/Chameleon/Run (84x38).png',
      nColumns: 12,
      nRows: 1,
      textureHeight: 38,
      textureWidth: 84,
  ...
  Enemy(EnemyType enemyType) : super.empty() {
    ...
    _myData = _enemyDetails[enemyType] as EnemyData;
